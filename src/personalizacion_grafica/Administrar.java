...
public class Administrar extends javax.swing.JFrame {
        Juegos ObxetoJuegos= new Juegos();
    ...
    private void nuevoJuego(ArrayList juegosAnhadidos) {
        Juegos j=ObxetoJuegos.nuevoJuego();
        ObxetoEscritura.escribirJuego(new File("Juegos.txt"), j, juegosAnhadidos);
